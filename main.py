...
def main(args):
    ...
    train_loader = torch.utils.data.DataLoader(Dataset(cfg.path_to_train_lmdb_dir),
                                               batch_size=cfg.train_batch_size_per_gpu * cfg.gpu, shuffle=True,
