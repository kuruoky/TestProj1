...
_EXAMPLE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='left', full_name='Example.left', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='top', full_name='Example.top', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='width', full_name='Example.width', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='height', full_name='Example.height', index=4,
